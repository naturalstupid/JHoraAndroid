...
def varsha_vimsottari_dasha_start_date(jd,place,ayanamsa_mode=None, years=1,divisional_chart_factor=1,chart_method=1):
...
def varsha_vimsottari_mahadasa(jdut1,place,years,ayanamsa_mode=None, divisional_chart_factor=1,chart_method=1):
    """List all mahadashas and their start dates"""
    if ayanamsa_mode is None: ayanamsa_mode = const._DEFAULT_AYANAMSA_MODE
    lord, start_date = varsha_vimsottari_dasha_start_date(jdut1,place,ayanamsa_mode=ayanamsa_mode, years=years,
...
# ---------------------- ALL TESTS ------------------------------
def varsha_vimsottari_dhasa_bhukthi(jd,place,ayanamsa_mode=None,years=1,include_antardhasa=True,divisional_chart_factor=1,chart_method=1):
    """
        Calculates Varsha Vimshottari (also called Mudda dhasa) Dasha-bhukthi-antara-sukshma-prana
    ...
    dashas = varsha_vimsottari_mahadasa(jd,place,ayanamsa_mode=ayanamsa_mode,years=years, divisional_chart_factor=divisional_chart_factor,
                                        chart_method=chart_method)
    dhasa_bukthi=[]
    ...
    return dhasa_bukthi
def mudda_dhasa_bhukthi(jd,place,ayanamsa_mode=None,years=1,include_antardhasa=True,divisional_chart_factor=1):
    return varsha_vimsottari_dhasa_bhukthi(jd,place,ayanamsa_mode=ayanamsa_mode,years=years,include_antardhasa=include_antardhasa,
