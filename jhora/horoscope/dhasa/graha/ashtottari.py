...
def ashtottari_adhipathi(nak):
    for key,value in ashtottari_adhipathi_dict.items():
        ...
        if nak1 >= starting_star and nak1 <= ending_star:
            return key,value
def ashtottari_dasha_start_date(jd,place,ayanamsa_mode=None,divisional_chart_factor=1,chart_method=1,star_position_from_moon=1,
    ...
    if dhasa_starting_planet in [*range(9)]:
        ...
        gl = drik.pranapada_lagna(jd, place,ayanamsa_mode=ayanamsa_mode,divisional_chart_factor=divisional_chart_factor)
        planet_long = gl[0]*30+gl[1]
...
def ashtottari_mahadasa(jd,place,ayanamsa_mode=None,divisional_chart_factor=1,chart_method=1,star_position_from_moon=1,
                        dhasa_starting_planet=1):
    """
    ...
    """
    lord, start_date = ashtottari_dasha_start_date(jd,place,ayanamsa_mode=ayanamsa_mode, divisional_chart_factor=divisional_chart_factor,
...
def ashtottari_anthara(dhasa_lord, bhukthi_lord,bhukthi_lord_start_date):
    ...
    for i in range(len(ashtottari_adhipathi_list)):
        ...
        lord = ashtottari_next_adhipati(lord)
    return retval
def get_ashtottari_dhasa_bhukthi(jd, place,ayanamsa_mode=None, divisional_chart_factor=1,chart_method=1,star_position_from_moon=1,
    ...
    dashas = ashtottari_mahadasa(jd,place,ayanamsa_mode=ayanamsa_mode, divisional_chart_factor=divisional_chart_factor,
