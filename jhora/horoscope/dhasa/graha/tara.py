...
def _antardhasa(lord,dhasa_method=1):
    ...
    return _bhukthis
def _dhasa_start(jd,place,ayanamsa_mode=None,period=None,star_position_from_moon=1,divisional_chart_factor=1,chart_method=1):
...
def get_dhasa_bhukthi(dob,tob,place,ayanamsa_mode=None,divisional_chart_factor=1,chart_method=1,years=1,months=1,sixty_hours=1,
    ...
    start_jd = _dhasa_start(jd_at_dob,place,ayanamsa_mode=ayanamsa_mode, period=_dhasa_duration, star_position_from_moon=1,
                            divisional_chart_factor=divisional_chart_factor,chart_method=chart_method)
    dhasa_info = []
    for _ in range(len(dhasa_adhipathi_dict)):
