...
def _antardhasa(lord):
    ...
    return _bhukthis
def _dhasa_start(jd,place,ayanamsa_mode=None,star_position_from_moon=1,divisional_chart_factor=1,chart_method=1,seed_star=8,
...
def get_dhasa_bhukthi(dob,tob,place,ayanamsa_mode=None,include_antardhasa=True,star_position_from_moon=1,use_tribhagi_variation=False,
    ...
    dhasa_lord, start_jd,_ = _dhasa_start(jd,place,ayanamsa_mode=ayanamsa_mode,star_position_from_moon=star_position_from_moon,
