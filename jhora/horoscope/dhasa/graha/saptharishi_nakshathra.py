...
def _dhasa_progression(jd,place,ayanamsa_mode=None,divisional_chart_factor=1,chart_method=1,star_position_from_moon=1,
    ...
    return _dp
def get_dhasa_bhukthi(dob,tob,place,ayanamsa_mode=None,divisional_chart_factor=1,chart_method=1,include_antardhasa=True,
    ...
    retval = []
    dhasa_progression = _dhasa_progression(jd, place,ayanamsa_mode=ayanamsa_mode, divisional_chart_factor=divisional_chart_factor,
