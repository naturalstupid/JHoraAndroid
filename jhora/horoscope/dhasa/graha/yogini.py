...
def _antardhasa(lord,antardhasa_option=1):
    ...
    return _bhukthis
def _dhasa_start(jd,place,ayanamsa_mode=None,divisional_chart_factor=1,star_position_from_moon=1,seed_star=7,dhasa_starting_planet=1):
    ...
    if dhasa_starting_planet in [*range(9)]:
        ...
        gl = drik.bhrigu_bindhu_lagna(jd, place,ayanamsa_mode=ayanamsa_mode,divisional_chart_factor=divisional_chart_factor)
        planet_long = gl[0]*30+gl[1]
    elif dhasa_starting_planet.upper()=='I':
        gl = drik.indu_lagna(jd, place,ayanamsa_mode=ayanamsa_mode,divisional_chart_factor=divisional_chart_factor)
        planet_long = gl[0]*30+gl[1]
        ...
        sp = sphuta.tri_sphuta(dob,tob,place,ayanamsa_mode=ayanamsa_mode,divisional_chart_factor=divisional_chart_factor)
...
def get_dhasa_bhukthi(dob,tob,place,ayanamsa_mode=None,include_antardhasa=True,use_tribhagi_variation=False,
