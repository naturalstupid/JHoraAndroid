...
def _antardhasa(lord,antardhasa_option=1):
    ...
    return _bhukthis
def _dhasa_start(jd,place,ayanamsa_mode=None,divisional_chart_factor=1,chart_method=1,star_position_from_moon=1,
...
def get_dhasa_bhukthi(dob,tob,place,ayanamsa_mode=None,divisional_chart_factor=1,chart_method=1,include_antardhasa=True,
    ...
    dhasa_lord, start_jd,_ = _dhasa_start(jd,place,ayanamsa_mode=ayanamsa_mode, divisional_chart_factor=divisional_chart_factor,
