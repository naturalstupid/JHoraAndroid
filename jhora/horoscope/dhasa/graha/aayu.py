...
def _get_global_constants(jd,place):
    ...
    """
    return
def get_dhasa_antardhasa(jd,place,ayanamsa_mode=None,aayur_type=None,include_antardhasa=True,apply_haranas=True,dhasa_method=2,
    ...
    bhava_houses = charts.bhava_houses(jd, place)
    subha_grahas, asubha_grahas = charts.benefics_and_malefics(jd, place, method=1)#BV Raman's method
    bm1 = drik.bhaava_madhya(jd, place,ayanamsa_mode=ayanamsa_mode,bhava_method=const.bhaava_madhya_method); bhava_madhya = bm1[:]+[bm1[0]]
    if _DEBUG: print('bhava madhya',[utils.to_dms(bm,is_lat_long='plong') for bm in bhava_madhya])
    bhava_lengths = [(bhava_madhya[i+1]-bhava_madhya[i])%60 for i in range(len(bhava_madhya)-1)]
...
def pindayu_dhasa_bhukthi(jd,place,ayanamsa_mode=None,include_antardhasa=True,apply_haranas=True,dhasa_method=2,
                          divisional_chart_factor=9,chart_method=1):
    return get_dhasa_antardhasa(jd, place,ayanamsa_mode=ayanamsa_mode, aayur_type=0, include_antardhasa=include_antardhasa, 
...
def nisargayu_dhasa_bhukthi(jd,place,ayanamsa_mode=None,include_antardhasa=True,apply_haranas=True,dhasa_method=2,
                          divisional_chart_factor=9,chart_method=1):
    return get_dhasa_antardhasa(jd, place,ayanamsa_mode=ayanamsa_mode, aayur_type=1, include_antardhasa=include_antardhasa, 
                                apply_haranas=apply_haranas, dhasa_method=dhasa_method,
                                divisional_chart_factor=divisional_chart_factor,chart_method=chart_method)[1]
def amsayu_dhasa_bhukthi(jd,place,ayanamsa_mode=None,include_antardhasa=True,apply_haranas=True,dhasa_method=2,
                          divisional_chart_factor=9,chart_method=1):
    return get_dhasa_antardhasa(jd, place,ayanamsa_mode=ayanamsa_mode, aayur_type=2, include_antardhasa=include_antardhasa, 
                                apply_haranas=apply_haranas, dhasa_method=dhasa_method,
                                divisional_chart_factor=divisional_chart_factor,chart_method=chart_method)[1]
def longevity(jd,place,ayanamsa_mode=None,aayu_type=None,dhasa_method=2):
    if ayanamsa_mode is None: ayanamsa_mode=const._DEFAULT_AYANAMSA_MODE
    _at,_adb = get_dhasa_antardhasa(jd, place,ayanamsa_mode=ayanamsa_mode, aayur_type=aayu_type, include_antardhasa=False, apply_haranas=True, dhasa_method=dhasa_method)
