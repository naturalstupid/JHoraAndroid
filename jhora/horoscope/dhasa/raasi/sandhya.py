...
def get_dhasa_antardhasa(dob,tob,place,ayanamsa_mode=None,divisional_chart_factor=1,years=1,months=1,sixty_hours=1,
    ...
    pp = charts.divisional_chart(jd_at_dob, place,ayanamsa_mode=ayanamsa_mode, divisional_chart_factor=divisional_chart_factor, years=years, months=months,sixty_hours=sixty_hours)
